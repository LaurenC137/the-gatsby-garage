...
`, 
    ...
    return (
        <div style={style} className={className}>
            <fieldset>
                <form onSubmit={handleSubmit} className="mb-4 grid grid-cols-1 md:grid-cols-[1fr_1fr_1fr_110px] gap-4 bg-stone-200 p-4">
                    <div>
                    ...
                    <div>
                        <strong>Color</strong>
                        <select name="color" defaultColor={defaultColor}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {data.cars.nodes.map(car => (
                    <div key={car.databaseId} className="flex flex-col border border-stone-200 bg-stone-100 p-2">
                        ...
                        <div className="lg:flex justify-between my-2 gap-2 font-heading text-xl font-bold">
                            ...
                            <div className="text-right">
                                <div class="bg-emerald-900 p-2 inline-block whitespace-nowrap text-white">
