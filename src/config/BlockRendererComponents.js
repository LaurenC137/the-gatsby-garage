...
import { CTAButton, MediaText, Cover, TickItem, CarSearch, ContactForm7 } from "../components";
        ...
        case "tgg/carprice": {
            return (
                <div className="flex justify-center">
                    <div className="bg-black text-white text-3xl py-5 px-8 font-heading">${numeral(block.attributes.price).format("0,0")}</div>
                </div>
            );
        }
        case "tgg/tickitem": {
